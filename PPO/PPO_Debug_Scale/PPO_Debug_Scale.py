...
from ActionScaleClipWrapper import ActionScaleAndClipWrapper
...
def train_eval(
    ...
    collect_env = ActionScaleAndClipWrapper(collect_env)
    ...
    eval_env = ActionScaleAndClipWrapper(eval_env)
    ...
    collect_actor = actor.Actor(
        ...
        collect_policy,
        train_step,
        steps_per_run=(sequence_length+1) * num_parallel_environments,
